...
$qry=mysql_query("select * from pelicula where Id='".$id."'");
...
$carro[md5($id)]=array('identificador'=>md5($id),'cantidad'=>$cantidad,'producto'=>$row['titulo'],'precio'=>$row['precioven'],'id'=>$id);
